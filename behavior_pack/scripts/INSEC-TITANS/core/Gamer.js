...
OverTakes(Player.prototype,{
    ...
    set mana(v){return  this.setDynamicProperty("resources_mana");},
    get iron(){return this.getDynamicProperty("resources_iron")??0;},
    set iron(v){return  this.setDynamicProperty("resources_iron");},
    get wood(){return this.getDynamicProperty("resources_wood")??0;},
    set wood(v){return  this.setDynamicProperty("resources_wood");},
    get stone(){return this.getDynamicProperty("resources_stone")??0;},
    set stone(v){return  this.setDynamicProperty("resources_stone");}
});